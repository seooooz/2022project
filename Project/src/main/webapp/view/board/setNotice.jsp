...
list1 = dao.SetboardList(1);
list2 = dao.SetboardList(2);
dao.close();
            ...
            <section class="py-5">
                <div class="container">
                    ...
                    <div class="text-center mb-5">
                        <h1 class="fw-bolder">셋팅 방법</h1>
                        
                    </div>
                    <div class="row gx-5">
                        <div>
                            <!-- FAQ Accordion 1-->
                            <h2 class="fw-bolder mb-3">JAVA</h2>
                        ...
                        %>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse" id="collapseOne<%=dto.getSet_num()%>" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <span id="content"><%=dto.getSet_content() %></span>
                                        </div>
                                    </div>
                                </div>
                         ...
                         <% } %>
                            ...
                            <!-- FAQ Accordion 2-->
                            <h2 class="fw-bolder mb-3">ORACLE</h2>
                            ...
                            <div class="accordion mb-5 mb-xl-0" id="accordionExample2">
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse" id="collapseOne<%=dto2.getSet_num() %>" aria-labelledby="headingOne" data-bs-parent="#accordionExample2">
                                        <div class="accordion-body">
                                          <span id="content"> <%=dto2.getSet_content() %></span>
                                        </div>
                                    </div>
                                </div>
                                 <%} %>
