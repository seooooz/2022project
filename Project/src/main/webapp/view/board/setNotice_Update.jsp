					...
					<form name="setriteFrm" method="post"
						...
						<table id="set-table">
							<tr>
								<th>게시판</th>
								<%if(code.equals("1")){ %>
								<td>&nbsp; <input type="radio" name="searchField" value="set-java"
									checked /> JAVA <input type="radio" name="searchField" value="set-oracle" />
									ORACLE
								</td>
								<%}else{ %>
								<td>&nbsp; <input type="radio" name="searchField" value="set-java"
									 /> JAVA <input type="radio" name="searchField" value="set-oracle" checked/>
									ORACLE
								</td>
								<%} %>
