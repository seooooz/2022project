...
list1 = dao2.SetboardList(1);
list2 = dao2.SetboardList(2);
dao.close();
dao2.close();
%>
<script>
function validateForm(form) {
	...
	function setUpdate(title, code, num){
		...
		var code = code;
		var num = num;
		location.href="/view/board/setNotice_Update.jsp?title="+title+"&code="+code+"&num="+num;
	}
	...
	<div class="col-lg-8">
		...
		<div class="card">
			<div class="card-header">
				<h4 id="teqh" class="card-title">셋팅방법</h4>
				<!-- 로그인 x => 글쓰기 안됨 -->
				<%
				if (UserId == null) {
				%>
				...
				%>
				<input type="button" class="btn btn-primary" value="글쓰기"
					onclick="location.href='/view/board/setNotice_write.jsp'">
				<%
				}
				%>
			</div>
				...
				<div class="profile-tab">
					...
					<div class="custom-tab-1">
						<ul class="nav nav-tabs">
							<li class="nav-item"><a href="#java-code" data-toggle="tab"
								class="nav-link active show">JAVA</a></li>
							<li class="nav-item"><a href="#oracle-code" data-toggle="tab"
								class="nav-link">ORACLE</a></li>
						</ul>
						<!-- 카테고리 안에 내용물 수정-->
						<div class="tab-content">
							<div id="java-code" class="tab-pane fade active show">
							...
							<!-- 코드 -->
							<div id="oracle-code" class="tab-pane fade">
									<div class="my-post-content pt-3">
										<div class="table-responsive">
											<table class="table mb-0">
												<div>
